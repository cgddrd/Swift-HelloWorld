    ...
    class func albumsWithJSON(allResults: NSArray) -> [Album] {
        ...
        if allResults.count > 0 {
            ...
            for result in allResults {
                ...
                // CG - Deal with converting price to Float.
                if price == nil {
                    ...
                    if price == nil {
                        ...
                        if priceFloat != nil {
                           ...
                           // price = NSString(format: "£%.2f", priceFloat!)
                        }
                ...
                // CG - If 'result["artworkUrl60"]' is nit 'nil', then use it, otherwise use "".
                ...
                // CG - If the price simply doesn't exist in the JSON, put a placeholder.
                if price == nil {
